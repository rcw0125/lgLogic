// 逻辑类CLadle_Com_Tie_Info源文件
// 本文件是由L3集成开发环境自动生成，在没有充分了解本文件的内容前，请不要随意修改本文件中的内容
// 否则可能带来严重后果。

#include "StdAfx.h"
#include "_CLadle_Com_Tie_Info.h"

IMPLEMENT_L3CLASS(CLadle_Com_Tie_Info,CL3Object,1)

BEGIN_L3PROPTABLE(CLadle_Com_Tie_Info,CL3Object)
	...
	L3PROP_STRING(Note)
END_L3PROPTABLE(CLadle_Com_Tie_Info)

BEGIN_L3METHODMAP(CLadle_Com_Tie_Info,CL3Object)
END_L3METHODMAP()

BEGIN_L3EVENTSINK_MAP(CLadle_Com_Tie_Info,CL3Object)
END_L3EVENTSINK_MAP(CLadle_Com_Tie_Info)

CLadle_Com_Tie_Info::CLadle_Com_Tie_Info(void)
{
}
