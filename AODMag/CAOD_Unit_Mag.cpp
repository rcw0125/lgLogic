...
/// 计算下一喷吹处理号
CString CAOD_Unit_Mag::CalculateNextTreatNo(LPCTSTR lpcszTreatNo)
{
...
/// 通用过程状态修改函数
BOOL CAOD_Unit_Mag::ChangeStatus(LONG nStatus)
{
	LONG nTrans = 0;
	if(!IsInTrans())
	{
...
/// <Method class="CAOD_Unit_Mag" name="GetInputSteels" type="L3RECORDSET">
/// 返回入口区域的待处理钢水信息。
/// </Method>
L3RECORDSET CAOD_Unit_Mag::GetInputSteels()
{
...
/// <Method class="CAOD_Unit_Mag" name="DesignateForWeighting" type="L3BOOL">
/// 指定即将称重的钢水炉号。
/// <Param name="MaterialID" type="L3STRING">即将称重的钢水号</Param>
/// </Method>
L3BOOL CAOD_Unit_Mag::DesignateForWeighting(L3STRING MaterialID)
{
	return SetPropValue(_T("WeightingSteel"),CL3Variant(MaterialID));
}

/// <Method class="CAOD_Unit_Mag" name="SetWeight" type="L3BOOL">
/// 处理称重信号。
/// <Param name="fWeight" type="L3DOUBLE">重量</Param>
/// </Method>
//L3BOOL CAOD_Unit_Mag::SetWeight(L3DOUBLE fWeight)
//{
//	LONG nTrans = 0;
//	if(!IsInTrans())
//	{
...
//	//钢包钢水重量 
//	/**********************************************/
//	//首先判断当前炉号是否存在CAOD_Ladle_Weight记录：存在就新增空炉号的记录；不存在就新增当前炉号的记录 2009-08-20 liao
...
/// <Method class="CAOD_Unit_Mag" name="DesignateLadle" type="L3BOOL">
/// 为A、B工位指定即将到达的钢水。
/// <Param name="Area" type="L3STRING">工位码：A，B</Param>
/// <Param name="MaterialID" type="L3STRING">钢水炉号</Param>
/// </Method>
L3BOOL CAOD_Unit_Mag::DesignateLadle(L3STRING Area, L3STRING MaterialID)
{
...
/// <Method class="CAOD_Unit_Mag" name="SteelArrived" type="L3BOOL">
/// 处理钢包到达事件。
/// <Param name="AreaID" type="L3STRING">钢包到达的工位</Param>
/// </Method>
L3BOOL CAOD_Unit_Mag::SteelArrived(L3STRING AreaID)
{
	...
	//2009-04-04
	if(!SetObjectPropValue(strAreaURI,_T("Status"),CL3Variant(CAOD_Unit_Mag::LFWaiting)))
	{
		if(nTrans > 0) Rollback(nTrans);
		return FALSE;
	}
...
/// </Method>
L3BOOL CAOD_Unit_Mag::FeedElement(L3RECORDSET rsElem)
{
...
/// <Method class="CAOD_Prod_Area" name="SetOxygen" type="L3BOOL">
/// 处理并记录LF炉定氧事件。
...
/// <Method class="CAOD_Unit_Mag" name="FeedWire" type="L3BOOL">
/// 处理并记录喂丝事件
/// <Param name="Area" type="L3STRING">进行喂丝的工位</Param>
/// <Param name="rsWire" type="L3RECORDSET">喂丝数据记录</Param>
/// </Method>
L3BOOL CAOD_Unit_Mag::FeedWire(L3STRING Area,L3RECORDSET rsWire)
{
...
/// <Method class="CAOD_Unit_Mag" name="StartProcess" type="L3BOOL">
/// 开始处理A、B两个之一工位上的钢水。
/// <Param name="Area" type="L3STRING">要开始处理的工位</Param>
/// </Method>
L3BOOL CAOD_Unit_Mag::StartProcess(L3STRING Area)
{
	CString strArea = String_BSTR2TChar(Area);
	strArea.Trim();
	if(strArea.IsEmpty() || (strArea !=_T("A") && strArea !=_T("B")))
	...
	// 检查状态 2009-01-08 
	if(Status != CAOD_Unit_Mag::LFWaiting)
	{
		if(nTrans > 0) Rollback(nTrans);
	...
	//if(nAreaStatus != CAOD_Unit_Mag::LFWaiting)
	//{
	//	if(nTrans > 0) Rollback(nTrans);
	//	SetL3LastError(XGMES_ERR_LF_WRONGSTATUS);
	//	return FALSE;
	...
	// 修改状态
	if(!ChangeStatus(CAOD_Unit_Mag::LFProcBegin))
	{
		if(nTrans > 0) Rollback(nTrans);
		return FALSE;
	}
...
/// <Method class="CAOD_Unit_Mag" name="StopProcess" type="BOOL">
/// 结束处理
/// </Method>
BOOL CAOD_Unit_Mag::StopProcess()
{
	LONG nTrans = 0;
	if(!IsInTrans())
	{
	...
	// 检查状态
	if(Status >= CAOD_Unit_Mag::LFProcEnd || Status <= CAOD_Unit_Mag::LFWaiting)
	{
		if(nTrans > 0) Rollback(nTrans);
		SetL3LastError(XGMES_ERR_LF_WRONGSTATUS);
		return FALSE;
	...
	//2008-12-23
	if(!ChangeStatus(CAOD_Unit_Mag::LFProcEnd))
	{
		if(nTrans > 0) Rollback(nTrans);
		return FALSE;
	}
	...
	if(!ChangeStatus(CAOD_Unit_Mag::LFWaiting))
	{
		if(nTrans > 0) Rollback(nTrans);
		return FALSE;
	}	
...
/// </Method>
L3BOOL CAOD_Unit_Mag::OnTimer(L3ULONG nEventID)
{
...
/// <Method class="CAOD_Unit_Mag" name="StartHeating" type="L3BOOL">
/// 处理加热开始事件
/// </Method>
L3BOOL CAOD_Unit_Mag::StartHeating()
{
	LONG nTrans = 0;
	if(!IsInTrans())
	{
	...
	if ((Status >= CAOD_Unit_Mag::LFProcBegin) && (Status < CAOD_Unit_Mag::LFProcEnd)) //2009-01-11 添加条件限制
	{
		//STRING HeatStartTime = COleDateTime::GetCurrentTime();
		if(!ChangeStatus(CAOD_Unit_Mag::LFHeatBegin))
		{
			if(nTrans > 0)
				Rollback(nTrans);
			return FALSE;
...
/// <Method class="CAOD_Unit_Mag" name="StopHeating" type="L3BOOL">
/// 处理加热结束事件
/// </Method>
L3BOOL CAOD_Unit_Mag::StopHeating()
{
	LONG nTrans = 0;
	if(!IsInTrans())
	{
	...
	/*	COleDateTimeSpan span = curTime - startTime;*/
		...
		if(!ChangeStatus(CAOD_Unit_Mag::LFHeatEnd))
		{
			if(nTrans > 0)
				Rollback(nTrans);
			return FALSE;
...
/// <Method class="CAOD_Unit_Mag" name="StartBlowing" type="BOOL">
/// 处理软吹开始事件
/// <Param name="Area" type="L3STRING">开始软吹的工位</Param>
/// </Method>
BOOL CAOD_Unit_Mag::StartBlowing(L3STRING Area)
{
	LONG nTrans = 0;
	if(!IsInTrans())
	{
	...
	if(!strAreaURI.IsEmpty())
	{
		if(!SetObjectPropValue(strAreaURI,_T("Status"),CL3Variant((LONG)CAOD_Unit_Mag::LFBlowBegin)))
		{
			if(nTrans > 0) Rollback(nTrans);
			return FALSE;
		}
	...
	rsStatus.SetFieldByName(_T("TreatNo"),CL3Variant(strTreatNo));
	rsStatus.SetFieldByName(_T("HeatID"),CL3Variant(strHeatID));
	rsStatus.SetFieldByName(_T("Status"),CL3Variant((LONG)CAOD_Unit_Mag::LFBlowBegin));
	rsStatus.SetFieldByName(_T("Change_Time"),CL3Variant(COleDateTime::GetCurrentTime()));
	if(CreateNewObjects(LF_PROCESS_STATUS_CLASS_URI,rsStatus) < 1)
	{
		if(nTrans > 0)
...
/// </Method>
L3BOOL CAOD_Unit_Mag::StopBlowing(L3STRING Area)
{
	LONG nTrans = 0;
	if(!IsInTrans())
	{
	...
	if(!strAreaURI.IsEmpty())
	{
		if(!SetObjectPropValue(strAreaURI,_T("Status"),CL3Variant((LONG)CAOD_Unit_Mag::LFBlowEnd)))
		{
			if(nTrans > 0) Rollback(nTrans);
			return FALSE;
		}
	...
	rsStatus.SetFieldByName(_T("TreatNo"),CL3Variant(strTreatNo));
	rsStatus.SetFieldByName(_T("HeatID"),CL3Variant(strHeatID));
	rsStatus.SetFieldByName(_T("Status"),CL3Variant((LONG)CAOD_Unit_Mag::LFBlowEnd));
	rsStatus.SetFieldByName(_T("Change_Time"),CL3Variant(COleDateTime::GetCurrentTime()));
	if(CreateNewObjects(LF_PROCESS_STATUS_CLASS_URI,rsStatus) < 1)
	{
		if(nTrans > 0)
...
/// <Method class="CAOD_Unit_Mag" name="SteelLeave" type="L3BOOL">
/// 处理钢水离站事件
/// <Param name="Area" type="L3STRING">离站钢水工位</Param>
/// </Method>
L3BOOL CAOD_Unit_Mag::SteelLeave(L3STRING Area)
{
	CString strArea = String_BSTR2TChar(Area);
	...
	//2009-04-03 状态判定
	if(iAreaStatus < CAOD_Unit_Mag::LFProcEnd||iAreaStatus==CAOD_Unit_Mag::LFBlowBegin)
	{
		SetL3LastError(XGMES_ERR_LF_WRONGSTATUS);
		return FALSE;
	}
...
/// <Param name="Reason" type="L3STRING">原因</Param>
/// </Method>
L3BOOL CAOD_Unit_Mag::ChangeSteelGradeApp(L3STRING Reason)
{
	CL3RecordSetWrap rsSteel;
...
/// <Method class="CAOD_Unit_Mag" name="SteelReturnApp" type="L3BOOL">
///  钢水回炉申请2009-02-28 增加炉号
/// <Param name="Reason" type="L3STRING">原因</Param>
/// </Method>
L3BOOL CAOD_Unit_Mag::SteelReturnApp(L3STRING Reason,L3STRING strHeatID)
{
...
/// <Method class="CAOD_Unit_Mag" name="SteelBackApp" type="L3BOOL">
///  钢水返送申请
/// <Param name="Reason" type="L3STRING">原因</Param>
/// </Method>
L3BOOL CAOD_Unit_Mag::SteelBackApp(L3STRING Reason,L3STRING strHeatID)
{
	CString csHeatID = strHeatID;
	CL3RecordSetWrap rsSteel;
...
/// <Method class="CAOD_Unit_Mag" name="AcceptMaterialDischargeData" type="L3RECORDSET">
/// 料仓加料数据采集
...
/// <Method class="CAOD_Unit_Mag" name="AcceptLFArrivalData" type="L3BOOL">
/// 接收LF炉钢包到达数据 2008-12-28
/// 新增4#LF，可共用此方法 hyh 2012-05-09
/// <Param name="rsData" type="L3RECORDSET">到达数据</Param>
/// </Method>
L3BOOL CAOD_Unit_Mag::AcceptLFArrivalData(L3RECORDSET rsData)
{
...
/// <Method class="CAOD_Unit_Mag" name="AcceptLFStartProcessData" type="L3BOOL">
/// 接收LF炉处理开始数据 2008-12-28
/// 新增4#LF，可共用此方法 hyh 2012-05-09
/// <Param name="rsData" type="L3RECORDSET">到达数据</Param>
/// </Method>
L3BOOL CAOD_Unit_Mag::AcceptLFStartProcessData(L3RECORDSET rsData)
{
	CL3RecordSetWrap rs = rsData;
	if(rs.GetRowCount() < 1)
		return TRUE;
...
/// <Method class="CAOD_Unit_Mag" name="AcceptLFEndProcessData" type="L3BOOL">
/// 接收LF炉处理结束数据 2008-12-30
/// 新增4#LF，可共用此方法 hyh 2012-05-09
/// <Param name="rsData" type="L3RECORDSET">到达数据</Param>
/// </Method>
L3BOOL CAOD_Unit_Mag::AcceptLFEndProcessData(L3RECORDSET rsData)
{
	CL3RecordSetWrap rs = rsData;
	if(rs.GetRowCount() < 1)
		return TRUE;
...
/// <Method class="CAOD_Unit_Mag" name="AcceptLFHeatData" type="L3BOOL">
/// 接收LF炉加热数据 2008-12-28
/// 新增4#LF，可共用此方法hyh 2012-05-09
/// <Param name="rsData" type="L3RECORDSET">加热开始数据</Param>
/// </Method>
L3BOOL CAOD_Unit_Mag::AcceptLFHeatData(L3RECORDSET rsData)
{
	CL3RecordSetWrap rs = rsData;
	if(rs.GetRowCount() < 1)
		return TRUE;
...
/// <Method class="CAOD_Unit_Mag" name="AcceptLFStartSoftBlowData" type="L3BOOL">
/// 接收LF炉软吹开始数据 2008-12-30
/// 新增4#LF，可共用此方法hyh 2012-05-09
/// <Param name="rsData" type="L3RECORDSET">到达数据</Param>
/// </Method>
L3BOOL CAOD_Unit_Mag::AcceptLFStartSoftBlowData(L3RECORDSET rsData)
{
	CL3RecordSetWrap rs = rsData;
	if(rs.GetRowCount() < 1)
		return TRUE;
...
/// <Method class="CAOD_Unit_Mag" name="AcceptLFStopSoftBlowData" type="L3BOOL">
/// 接收LF炉处理结束数据 2008-12-30
/// 新增4#LF，可共用此方法hyh 2012-05-09
/// <Param name="rsData" type="L3RECORDSET">到达数据</Param>
/// </Method>
L3BOOL CAOD_Unit_Mag::AcceptLFStopSoftBlowData(L3RECORDSET rsData)
{
	CL3RecordSetWrap rs = rsData;
	if(rs.GetRowCount() < 1)
		return TRUE;
...
/// <Method class="CAOD_Unit_Mag" name="AcceptLFTempData" type="L3BOOL">
/// 接收LF炉测温数据 2008-12-30
/// 新增4#LF，可共用此方法 hyh 2012-05-09
/// <Param name="rsData" type="L3RECORDSET">测温数据</Param>
/// </Method>
L3BOOL CAOD_Unit_Mag::AcceptLFTempData(L3RECORDSET rsData)
{
	CL3RecordSetWrap rs = rsData;
	if(rs.GetRowCount() < 1)
		return TRUE;
	...
	if(!CreateClassPropSet(_T("XGMESLogic\\LFMag\\CAOD_Temp_Data"),rsTemp))
	{
		return FALSE;
	}
	...
	while (!rsTemp.IsEOF())
	{
		...
		CString csHeatID;
		if (nStatus == CAOD_Unit_Mag::LFWaiting)
		{
	...
	rsTemp.MoveFirst();
	if(CreateNewObjects(_T("XGMESLogic\\LFMag\\CAOD_Temp_Data"),rsTemp) < rsTemp.GetRowCount())
	{
		return FALSE;
	}
...
BOOL CAOD_Unit_Mag::ChangeAreaStatus(LPCTSTR csAreaID,LONG nStatus)
{
...
/// <Method class="CAOD_Unit_Mag" name="SetTreatNoForTempDataBeforeProcess" type="L3BOOL">
/// 对处理开始前测温设置处理号数据项 2008-12-30
/// <Param name="csHeatID" type="LPCTSTR">炉号</Param>
/// <Param name="csTreatNo" type="LPCTSTR">处理号</Param>
/// </Method>
L3BOOL CAOD_Unit_Mag::SetTreatNoForTempDataBeforeProcess(LPCTSTR csHeatID,LPCTSTR csTreatNo)
{
	CString strSQL;
	strSQL.Format(_T("select * from CAOD_Temp_Data where HeatID = '%s' order by MeasureTime"),csHeatID);
	CL3RecordSetWrap rs;
	if(!Query(strSQL,rs))
		return FALSE;
...
/// <Method class="CAOD_Unit_Mag" name="SetDepartureTemp" type="L3BOOL">
/// 设置离站温度 2009-01-02
/// <Param name="csTreatNo" type="LPCTSTR">处理号</Param>
/// </Method>
L3BOOL CAOD_Unit_Mag::SetDepartureTemp(LPCTSTR csTreatNo)
{
	CString strSQL;
	strSQL.Format(_T("select * from CAOD_Temp_Data where TreatNo = '%s' order by MeasureTime desc"),csTreatNo);
	CL3RecordSetWrap rs;
	if(!Query(strSQL,rs))
		return FALSE;
...
/// <Method class="CAOD_Unit_Mag" name="SetWireTemp" type="L3BOOL">
/// 设置钙处理结束温度 2009-01-02
/// <Param name="csTreatNo" type="LPCTSTR">处理号</Param>
/// </Method>
L3BOOL CAOD_Unit_Mag::SetWireTemp(LPCTSTR csTreatNo)
{
	CString strSQL;
	strSQL.Format(_T("select * from CAOD_Temp_Data where TreatNo = '%s' order by MeasureTime desc"),csTreatNo);
	CL3RecordSetWrap rs;
...
/// <Method class="CAOD_Unit_Mag" name="AcceptLFWireData" type="L3BOOL">
/// 接收LF炉喂线数据 2009-01-02
/// <Param name="rsData" type="L3RECORDSET">喂线数据</Param>
/// </Method>
L3BOOL CAOD_Unit_Mag::AcceptLFWireData(L3RECORDSET rsData)
{
	...
	CL3RecordSetWrap rsLog;
	if(!CreateClassPropSet(_T("XGMESLogic\\LFMag\\CAOD_Wire_Data"),rsLog))
		return NULL;
	...
	if(CreateNewObjects(_T("XGMESLogic\\LFMag\\CAOD_Wire_Data"),rsLog) < rsLog.GetRowCount())
		return FALSE;
...
/// <Method class="CAOD_Unit_Mag" name="AcceptLFOxygenData" type="L3BOOL">
/// 接收LF炉定氧数据 2009-01-02
/// 新增4#LF，可共用此方法 hyh 2012-05-09
/// <Param name="rsData" type="L3RECORDSET">定氧数据</Param>
/// </Method>
L3BOOL CAOD_Unit_Mag::AcceptLFOxygenData(L3RECORDSET rsData)
{
	CL3RecordSetWrap rs = rsData;
	if(rs.GetRowCount() < 1)
		return TRUE;
	...
	if(!CreateClassPropSet(_T("XGMESLogic\\LFMag\\CAOD_Oxygen_Data"),rsOxygen))
	{
		return FALSE;
	}
	...
	rsOxygen.MoveFirst();
	if(CreateNewObjects(_T("XGMESLogic\\LFMag\\CAOD_Oxygen_Data"),rsOxygen) < rsOxygen.GetRowCount())
	{
		return FALSE;
	}
...
/// <Method class="CAOD_Unit_Mag" name="AcceptLFWeightData" type="L3BOOL">
/// 接收LF炉称重数据 2009-01-08
/// <Param name="rsData" type="L3RECORDSET">称重数据</Param>
/// </Method>
L3BOOL CAOD_Unit_Mag::AcceptLFWeightData(L3RECORDSET rsData)
{
	//CL3RecordSetWrap rs = rsData;
	//if(rs.GetRowCount() < 1)
	//	return TRUE;
...
L3RECORDSET CAOD_Unit_Mag::GetPreThreeHeatID()
{
	...
	CString csTempSQL =_T("select * from (select HeatID from CAOD_Base_Data where substr(TreatNo,1,1) = '%s'  order by  ProductionDate desc) where rownum < 5");
	CString csSQL;
...
/// <Method class="CAOD_Unit_Mag" name="DoBlowwing" type="L3BOOL">
/// 判定是否软吹开始 2009-03-09
/// <Param name="strAreaUri" type="LPCTSTR">工序对象Uri</Param>
/// <Param name="strHeatID" type="LPCTSTR">炉号</Param>
/// </Method>
L3BOOL CAOD_Unit_Mag::DoBlowwing(LPCTSTR strAreaUri,LPCTSTR strHeatID)
{
...
/// <Method class="CAOD_Unit_Mag" name="AcceptLFHeatGears" type="L3BOOL">
/// 接收LF加热挡位数据 2009-03-23
/// 新增4#LF，可共用此方法hyh 2012-05-09
/// <Param name="rsData" type="L3RECORDSET">挡位数据</Param>
/// </Method>
L3BOOL CAOD_Unit_Mag::AcceptLFHeatGears(L3RECORDSET rsData)
{
	CL3RecordSetWrap rs = rsData;
	if(rs.GetRowCount() < 1)
		return TRUE;
	...
	if(!CreateClassPropSet(_T("XGMESLogic\\LFMag\\CAOD_Heat_Gears"),rsGears))
	{
		return FALSE;
	}
	...
	rsGears.MoveFirst();
	if(CreateNewObjects(_T("XGMESLogic\\LFMag\\CAOD_Heat_Gears"),rsGears) < rsGears.GetRowCount())
	{
		return FALSE;
	}
...
/// <Method class="CAOD_Unit_Mag" name="AcceptLFBlowArData" type="L3BOOL">
/// 接收LF炉吹氩流量数据 2009-03-23
/// 新增4#LF，可共用此方法hyh 2012-05-09
/// <Param name="rsData" type="L3RECORDSET">吹氩流量数据</Param>
/// </Method>
L3BOOL CAOD_Unit_Mag::AcceptLFBlowArData(L3RECORDSET rsData)
{
	CL3RecordSetWrap rs = rsData;
	if(rs.GetRowCount() < 1)
		return TRUE;
	...
	if(!CreateClassPropSet(_T("XGMESLogic\\LFMag\\CAOD_BlowAr_Data"),rsBlowAr))
	{
		return FALSE;
	}
	...
	rsBlowAr.MoveFirst();
	if(CreateNewObjects(_T("XGMESLogic\\LFMag\\CAOD_BlowAr_Data"),rsBlowAr) < rsBlowAr.GetRowCount())
	{
		return FALSE;
	}
...
/// <Method class="CAOD_Unit_Mag" name="SetTreatNoForBlowArData" type="L3BOOL">
/// 对处理开始前吹氩数据设置处理号数据项 2009-03-23
/// <Param name="csHeatID" type="LPCTSTR">炉号</Param>
/// <Param name="csTreatNo" type="LPCTSTR">处理号</Param>
/// </Method>
L3BOOL CAOD_Unit_Mag::SetTreatNoForBlowArData(LPCTSTR csHeatID,LPCTSTR csTreatNo)
{
	CString strSQL;
	strSQL.Format(_T("select * from CAOD_BlowAr_Data where HeatID = '%s' and TreatNo is null order by LogTime"),csHeatID);
	CL3RecordSetWrap rs;
	if(!Query(strSQL,rs))
		return FALSE;
	...
	{
		CString csGUID = rs.GetFieldByName(_T("GUID")).ToCString();
        CString csTempDataUri = CL3NameParser::MergeClassDomainName(_T("XGMESLogic\\LFMag\\CAOD_BlowAr_Data"),csGUID);
		SetObjectPropValue(csTempDataUri,_T("TreatNo"),CL3Variant(csTreatNo));
		rs.MoveNext();
	}
...
/// <Method class="CAOD_Unit_Mag" name="AcceptLFBlowArFlow" type="L3BOOL">
/// 接收LF实绩吹氩数据 2009-03-23
/// <Param name="rsData" type="L3RECORDSET">挡位数据</Param>
/// </Method>
L3BOOL CAOD_Unit_Mag::AcceptLFBlowArFlow(L3RECORDSET rsData)
{
	CL3RecordSetWrap rs = rsData;
	int rsCount = rs.GetRowCount();
	if(rsCount < 1)
	...
	for(int i=0;i<rsCount;i++) //2009-03-05 增加多数据收集
	{
		...
		{
			//获取LF管理对象
			CString strLFMag = CL3NameParser::MergeClassDomainName(_T("XGMESLogic\\LFMag\\CAOD_Unit_Mag"),strLFID);
		...
		else //软吹
		{
			...
			CString strLFProdArea = CL3NameParser::MergeClassDomainName(_T("XGMESLogic\\LFMag\\CAOD_Prod_Area"),strAreaID);
...
//计算等压钢时间2009-03-28
L3LONG CAOD_Unit_Mag::CalculateHoldTime(LPCTSTR lpcszTreatNo,L3DATETIME dArrival)
{
    ...
    CL3Variant valEndTime = GetObjectPropValue(_T("XGMESLogic\\LFMag\\CAOD_Process_Data\\")+csLastTreatNo,_T("End_Time"));
...
/// 获取前处理号 2009-03-28
CString CAOD_Unit_Mag::GetPreviousTreatNo(LPCTSTR lpcszTreatNo)
{
	...
	CString csTempSQL =_T("select Max(TreatNo) as TreatNo from CAOD_Base_Data where substr(TreatNo,1,1) = '%s' and TreatNo < '%s'");
	CString csSQL;
...
/// <Method class="CAOD_Unit_Mag" name="ModifyLadleGrade" type="L3LONG">
/// 修改包况//2009-03-30 Liao
/// <Param name="strTreatNo" type="L3STRING">处理号</Param>
/// <Param name="strLadleGrade" type="L3STRING">包况</Param>
/// </Method>
L3LONG CAOD_Unit_Mag::ModifyLadleGrade(L3STRING strTreatNo, L3STRING strLadleGrade)
{
	// TODO : 请在此添加逻辑代码
...
/// <Method class="CAOD_Unit_Mag" name="CalEleRateValue" type="L3LONG">
/// 计算最进化验结果比值
...
/// </Method>
L3FLOAT CAOD_Unit_Mag::CalEleRateValue(L3STRING strHeatID, L3STRING strEleName1,L3STRING strEleName2)
{
	CString csHeatID=strHeatID;
