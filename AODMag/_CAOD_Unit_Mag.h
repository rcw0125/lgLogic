...
protected:
	...
	/// <Property class="CAOD_Unit_Mag" name="TreatNo" type="L3STRING">
	/// 当前处理号
	/// </Property>
	DECLARE_L3PROP_STRING(TreatNo)

	/// <Property class="CAOD_Unit_Mag" name="NextTreatNo" type="L3STRING">
	/// 下一处理号
	/// </Property>
	...
	/// <Property class="CAOD_Unit_Mag" name="NextSteel" type="L3STRING">
	/// 下一个上线的钢水
	/// </Property>
	DECLARE_L3PROP_STRING(NextSteel)

	/// <Property class="CAOD_Unit_Mag" name="CurArea" type="L3STRING">
	/// 当前正在处理的工位
	/// </Property>
	DECLARE_L3PROP_STRING(CurArea)

	/// <Property class="CAOD_Unit_Mag" name="ProcStartTime" type="L3DATETIME">
	/// 开始处理时间
	/// </Property>
	...
	DECLARE_L3PROP_DATETIME(Return_End_Time)
	DECLARE_L3PROP_DATETIME(Tapping_Start_Time)
	DECLARE_L3PROP_DATETIME(Tapping_End_Time)
	DECLARE_L3PROP_SHORT(Lance_Age)
	DECLARE_L3PROP_SHORT(Lance_No)
	DECLARE_L3PROP_SHORT(Furnace_No)
	DECLARE_L3PROP_SHORT(Furnace_Age)
	DECLARE_L3PROP_DOUBLE(Steel_Weight)
