// 逻辑类CAOD_Prod_Area的用户逻辑程序源文件
// 用户系统的逻辑程序应放在本文件中实现，逻辑函数的定义应放在_CAOD_Prod_Area.h中。
// 由于本文件中定义的函数均为L3集成开发环境自动生成，且在_CAOD_Prod_Area.h和
...
//当对象被卸载时，被调用
void CAOD_Prod_Area::OnUnloaded()
{
	__super::OnUnloaded();
...
/// </summary>
BOOL CAOD_Prod_Area::OnBeforeProcess(L3RECORDSET rsParameter)
{
	// TODO: 在此处编辑相关功能的处理代码
...
/// </summary>
BOOL CAOD_Prod_Area::ProcessMaterials(L3RECORDSET rsMaterials,L3RECORDSET rsParameter,L3LONG* pnProcessType,L3RECORDSET *prsProducts,L3RECORDSET *prsMaterialMap)
{
	// TODO: 在此处编辑相关功能的处理代码
...
/// RET << 成功返回TRUE；失败返回FALSE。
/// </summary>
BOOL CAOD_Prod_Area::OnAfterProcessed(L3RECORDSET rsMaterials,L3RECORDSET rsParameter,L3LONG nProcessType,L3RECORDSET rsProducts,L3RECORDSET rsMaterialMap)
{
	// TODO: 在此处编辑相关功能的处理代码
...
/// 材料添加前导处理
/// </summary>
BOOL CAOD_Prod_Area::OnBeforeAddMaterials(L3RECORDSET rsMaterials)
{
...
/// 材料添加后续处理
/// </summary>
BOOL CAOD_Prod_Area::OnAfterMaterialsAdded(L3RECORDSET rsMaterials)
{
...
/// 材料移出后续处理
/// </summary>
BOOL CAOD_Prod_Area::OnAfterMaterialsRemoved(L3RECORDSET rsMaterials)
{
	CL3RecordSetWrap rs = rsMaterials;
	if(rs.GetRowCount() < 1)
	{
...
/// RET << 位置编码
/// </summary>
CString CAOD_Prod_Area::GetPositionCode()
{
...
/// </Method>
L3BOOL CAOD_Prod_Area::OnTimer(L3ULONG nEventID)
{
	...
	//	CString csSql;
	//	csSql.Format(_T("select SoftBlow_StartTime from CAOD_Process_Data where HeatID='%s'"),csHeatID);
	//	CL3RecordSetWrap rs;
...
/// 启动定时器事件
/// </Method>
L3BOOL CAOD_Prod_Area::SetLFAreaTimer()
{
	//SoftBlowTime = 0;
...
/// 停止定时器事件
/// </Method>
L3BOOL CAOD_Prod_Area::KillLFAreaTimer()
{
	if(m_iTimer != 0)
