// 逻辑类CBulk_Store_Communicator头文件
// 本文件是由L3集成开发环境自动生成，在没有充分了解本文件的内容前，请不要随意修改本文件中的内容
// 否则可能带来严重后果。
#pragma once
#include "MESCommunicator.h"

class CBulk_Store_Communicator :
	public MESCommunicator
{
public:
	CBulk_Store_Communicator(void);
	virtual ~CBulk_Store_Communicator(void);

	DECLARE_L3CLASS(CBulk_Store_Communicator,XGMESLogic\\BulkStoreMag, Name)
	DECLARE_L3PROPTABLE()
	DECLARE_L3METHODMAP(CBulk_Store_Communicator)
