...
IMPLEMENT_L3CLASS(CDEP_Process_Data,CL3Object,1)

BEGIN_L3PROPTABLE(CDEP_Process_Data,CL3Object)
	...
	L3PROP_FLOAT(LadleAge)

			/// 钢包包壁最高温度
	/// </Property>
	L3PROP_LONG(Ladle_Bi_Temp)

				/// 钢包渣线最高温度
	/// </Property>
	L3PROP_LONG(Ladle_Line_Temp)

				/// 钢包包底最高温度
	/// </Property>
	L3PROP_LONG(Ladle_Bottom_Temp)
...
END_L3PROPTABLE(CDEP_Process_Data)

BEGIN_L3METHODMAP(CDEP_Process_Data,CL3Object)
END_L3METHODMAP()

BEGIN_L3EVENTSINK_MAP(CDEP_Process_Data,CL3Object)
END_L3EVENTSINK_MAP(CDEP_Process_Data)

CDEP_Process_Data::CDEP_Process_Data(void)
{
}
