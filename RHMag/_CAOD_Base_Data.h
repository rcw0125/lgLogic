...
public:
	...
	DECLARE_L3CLASS(CAOD_Base_Data,XGMESLogic\\AODMag, HeatID)
	DECLARE_L3PROPTABLE()
	...
	/// <Property class="CAOD_Base_Data" name="Shift" type="L3SHORT">
	/// 班次
	/// </Property>
	DECLARE_L3PROP_STRING(Shift)

	/// <Property class="CAOD_Base_Data" name="Team" type="L3SHORT">
	/// 班别
	/// </Property>
	...
	/// <Property class="CAOD_Base_Data" name="StatisticsDate" type="L3DATETIME">
	/// 统计日期
	/// </Property>
