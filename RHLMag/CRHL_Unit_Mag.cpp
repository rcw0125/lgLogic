//// 逻辑类CRHL_Unit_Mag的用户逻辑程序源文件
//// 用户系统的逻辑程序应放在本文件中实现，逻辑函数的定义应放在_CRHL_Unit_Mag.h中。
//// 由于本文件中定义的函数均为L3集成开发环境自动生成，且在_CRHL_Unit_Mag.h和
...
///// </summary>
//BOOL CRHL_Unit_Mag::GetProduceAreas(CStringList& lstURIs)
//{
...
///// 得到机组前序材料缓冲区的URI
///// </summary>
//CString CRHL_Unit_Mag::GetInputCache()
//{
//	CString strID = GetIdentity().ToCString();
//	CString strCache;
...
///// 得到机组后继材料缓冲区的URI
///// </summary>
//CString CRHL_Unit_Mag::GetOutputCache()
//{
//	// 根据计划转运材料，无固定出口缓存
//	return _T("");
//}
...
///// </summary>
//BOOL CRHL_Unit_Mag::OnBeforeFeedMaterials(L3RECORDSET rsMaterialInfo)
//{
//	// TODO: 在此处编辑相关功能的处理代码
//
...
///// </summary>
//BOOL CRHL_Unit_Mag::OnAfterMaterialsFeeded(L3RECORDSET rsMaterialInfo)
//{
//	// TODO: 在此处编辑相关功能的处理代码
//
...
///// 返回机组上料记录的类型URI
///// </summary>
//CString CRHL_Unit_Mag::GetFeedingLogType()
//{
//	// TODO: 在此处编辑相关功能的处理代码
//
...
///// RET << void
///// </summary>
//void CRHL_Unit_Mag::PrepareFeedingLogs(L3RECORDSET rsFeedingLogs)
//{
//	// TODO: 在此处编辑相关功能的处理代码
//
...
///// </summary>
//BOOL CRHL_Unit_Mag::PrepareProcessParameters(LPCTSTR lpcszArea,L3RECORDSET rsParameters)
//{
//	// TODO: 在此处编辑相关功能的处理代码
//
...
///// RET << 成功返回TRUE；失败返回FALSE。
///// </summary>
//BOOL CRHL_Unit_Mag::OnAfterProcessCompleted(LPCTSTR lpcszArea,LONG nProcessType,L3RECORDSET rsProducts)
//{
//	// TODO: 在此处编辑相关功能的处理代码
//
...
///// </summary>
//BOOL CRHL_Unit_Mag::OnBeforeDeliverMaterials(L3RECORDSET rsMaterialInfo)
//{
//	// TODO: 在此处编辑相关功能的处理代码
//
...
///// RET << 成功返回TRUE；失败返回FALSE。
///// </summary>
//BOOL CRHL_Unit_Mag::OnAfterMaterialsDelivered(L3RECORDSET rsMaterialInfo)
//{
//	// TODO: 在此处编辑相关功能的处理代码
//
...
///// 返回机组产出记录的类型URI
///// </summary>
//CString CRHL_Unit_Mag::GetDeliveryLogType()
//{
//	// TODO: 在此处编辑相关功能的处理代码
//
...
///// RET <<void
///// </summary>
//void CRHL_Unit_Mag::PrepareDeliveryLogs(L3RECORDSET rsDeliveryLog)
//{
//	// TODO: 在此处编辑相关功能的处理代码
//
...
///// 返回本机组的通讯器对象的URI
///// </summary>
//CString CRHL_Unit_Mag::GetCommunicator()
//{
//	// TODO: 在此处编辑相关功能的处理代码
//
...
///// RET << 成功返回TRUE；失败返回FALSE。
///// </summary>
//BOOL CRHL_Unit_Mag::PreparePlanForSending(LPCTSTR lpcszPlanType,L3RECORDSET rsPlan,L3RECORDSET* pprsSend)
//{
//	// TODO: 在此处编辑相关功能的处理代码
//
...
///// RET << 成功返回TRUE；失败返回FALSE。
///// </summary>
//BOOL CRHL_Unit_Mag::OnAfterPlansSent(L3RECORDSET rsSend)
//{
//	// TODO: 在此处编辑相关功能的处理代码
//
...
///// RET << 成功返回TRUE；失败返回FALSE。
///// </summary>
//BOOL CRHL_Unit_Mag::PreparePlanForCancel(LPCTSTR lpcszPlanType,L3RECORDSET rsPlan,L3RECORDSET* pprsCancel)
//{
//	// TODO: 在此处编辑相关功能的处理代码
//
...
///// RET << 成功返回TRUE；失败返回FALSE。
///// </summary>
//BOOL CRHL_Unit_Mag::OnAfterPlansCanceled(L3RECORDSET rsCancel)
//{
//	// TODO: 在此处编辑相关功能的处理代码
//
...
///// </summary>
//BOOL CRHL_Unit_Mag::HandleMaterialFeedingEvent(MatEnterArea *pEvt)
//{
//	// TODO: 在此处编辑相关功能的处理代码
//
...
///// RET << 返回TRUE表示已经成功处理。返回FALSE表示使用系统缺省处理方式。
///// </summary>
//BOOL CRHL_Unit_Mag::HandleMaterialEnterAreaEvent(MatEnterArea *pEvt)
//{
//	// TODO: 在此处编辑相关功能的处理代码
//
...
///// RET << 返回TRUE表示已经成功处理。返回FALSE表示使用系统缺省处理方式。
///// </summary>
//BOOL CRHL_Unit_Mag::HandleMaterialLeaveAreaEvent(MatLeaveArea *pEvt)
//{
//	// TODO: 在此处编辑相关功能的处理代码
//
...
///// RET << 返回TRUE表示已经成功处理。返回FALSE表示使用系统缺省处理方式。
///// </summary>
//BOOL CRHL_Unit_Mag::HandleMaterialProducedEvent(MatProduced *pEvt)
//{
//	// TODO: 在此处编辑相关功能的处理代码
//
...
///// RET << 返回TRUE表示已经成功处理。返回FALSE表示使用系统缺省处理方式。
///// </summary>
//BOOL CRHL_Unit_Mag::HandleUnitMeasureChangedEvent(UnitMeasure *pEvt)
//{
//	// TODO: 在此处编辑相关功能的处理代码
//
...
//
///// 计算下一喷吹处理号
//CString CRHL_Unit_Mag::CalculateNextTreatNo(LPCTSTR lpcszTreatNo)
//{
...
//
///// 通用过程状态修改函数
//BOOL CRHL_Unit_Mag::ChangeStatus(LONG nStatus)
//{
//	LONG nTrans = 0;
//	if(!IsInTrans())
//	{
...
//
///// 通用计划状态修改函数
//BOOL CRHL_Unit_Mag::ChangePlanStatus(LPCTSTR lpcszHeatID,LPCTSTR lpcszTreatNo,LPCTSTR Status)
//{
...
//}
//
///// <Method class="CRHL_Unit_Mag" name="GetInputSteels" type="L3RECORDSET">
///// 返回入口区域的待处理钢水信息。
///// </Method>
//L3RECORDSET CRHL_Unit_Mag::GetInputSteels()
//{
...
//}
//
///// <Method class="CRHL_Unit_Mag" name="DesignateForWeighting" type="L3BOOL">
///// 指定即将称重的钢水炉号。
///// <Param name="MaterialID" type="L3STRING">即将称重的钢水号</Param>
///// </Method>
//L3BOOL CRHL_Unit_Mag::DesignateForWeighting(L3STRING MaterialID)
//{
//	return SetPropValue(_T("WeightingSteel"),CL3Variant(MaterialID));
//}
//
///// <Method class="CRHL_Unit_Mag" name="SetWeight" type="L3BOOL">
///// 处理称重信号。
///// <Param name="fWeight" type="L3DOUBLE">重量</Param>
///// </Method>
//L3BOOL CRHL_Unit_Mag::SetWeight(L3DOUBLE fWeight)
//{
//	LONG nTrans = 0;
//	if(!IsInTrans())
//	{
...
//	//钢包钢水重量 
//	/**********************************************/
//	//首先判断当前炉号是否存在CRHL_Ladle_Weight记录：存在就新增空炉号的记录；不存在就新增当前炉号的记录 2009-08-20 liao
...
//}
//
///// <Method class="CRHL_Unit_Mag" name="DesignateLadle" type="L3BOOL">
///// 为A、B工位指定即将到达的钢水。
///// <Param name="Area" type="L3STRING">工位码：A，B</Param>
///// <Param name="MaterialID" type="L3STRING">钢水炉号</Param>
///// </Method>
//L3BOOL CRHL_Unit_Mag::DesignateLadle(L3STRING Area, L3STRING MaterialID)
//{
...
//
//
///// <Method class="CRHL_Unit_Mag" name="SteelArrived" type="L3BOOL">
///// 处理钢包到达事件。
///// <Param name="AreaID" type="L3STRING">钢包到达的工位</Param>
///// </Method>
//L3BOOL CRHL_Unit_Mag::SteelArrived(L3STRING AreaID)
//{
...
//
//	//2009-04-04
//	if(!SetObjectPropValue(strAreaURI,_T("Status"),CL3Variant(CRHL_Unit_Mag::LFWaiting)))
//	{
//		if(nTrans > 0) Rollback(nTrans);
//		return FALSE;
//	}
...
//}
//
///// <Method class="CRHL_Unit_Mag" name="FeedElement" type="L3BOOL">
///// 向LF炉加料
///// <Param name="rsElem" type="L3RECORDSET">加料数据</Param>
///// </Method>
//L3BOOL CRHL_Unit_Mag::FeedElement(L3RECORDSET rsElem)
//{
...
//}
//
///// <Method class="CRHL_Unit_Mag" name="SetTemperature" type="L3BOOL">
///// 处理并记录测温事件
///// <Param name="rsTemp" type="L3RECORDSET">测温事件数据</Param>
///// </Method>
//L3BOOL CRHL_Unit_Mag::SetTemperature(L3RECORDSET rsTemp)
//{
...
//}
//
///// <Method class="CRHL_Prod_Area" name="SetOxygen" type="L3BOOL">
///// 处理并记录LF炉定氧事件。
///// <Param name="rsOxygen" type="L3RECORDSET">定氧数据</Param>
///// </Method>
//L3BOOL CRHL_Unit_Mag::SetOxygen(L3RECORDSET rsOxygen)
//{
...
//}
//
///// <Method class="CRHL_Unit_Mag" name="FeedWire" type="L3BOOL">
///// 处理并记录喂丝事件
///// <Param name="Area" type="L3STRING">进行喂丝的工位</Param>
///// <Param name="rsWire" type="L3RECORDSET">喂丝数据记录</Param>
///// </Method>
//L3BOOL CRHL_Unit_Mag::FeedWire(L3STRING Area,L3RECORDSET rsWire)
//{
...
//}
//
///// <Method class="CRHL_Unit_Mag" name="StartProcess" type="L3BOOL">
///// 开始处理A、B两个之一工位上的钢水。
///// <Param name="Area" type="L3STRING">要开始处理的工位</Param>
///// </Method>
//L3BOOL CRHL_Unit_Mag::StartProcess(L3STRING Area)
//{
//	CString strArea = String_BSTR2TChar(Area);
//	strArea.Trim();
//	if(strArea.IsEmpty() || (strArea !=_T("A") && strArea !=_T("B")))
...
//
//	// 检查状态 2009-01-08 
//	if(Status != CRHL_Unit_Mag::LFWaiting)
//	{
//		if(nTrans > 0) Rollback(nTrans);
...
//	//if(nAreaStatus != CRHL_Unit_Mag::LFWaiting)
//	//{
//	//	if(nTrans > 0) Rollback(nTrans);
//	//	SetL3LastError(XGMES_ERR_LF_WRONGSTATUS);
//	//	return FALSE;
...
//
//	// 修改状态
//	if(!ChangeStatus(CRHL_Unit_Mag::LFProcBegin))
//	{
//		if(nTrans > 0) Rollback(nTrans);
//		return FALSE;
//	}
...
//}
//
///// <Method class="CRHL_Unit_Mag" name="StopProcess" type="BOOL">
///// 结束处理
///// </Method>
//BOOL CRHL_Unit_Mag::StopProcess()
//{
//	LONG nTrans = 0;
//	if(!IsInTrans())
//	{
...
//
//	// 检查状态
//	if(Status >= CRHL_Unit_Mag::LFProcEnd || Status <= CRHL_Unit_Mag::LFWaiting)
//	{
//		if(nTrans > 0) Rollback(nTrans);
//		SetL3LastError(XGMES_ERR_LF_WRONGSTATUS);
//		return FALSE;
...
//
//	//2008-12-23
//	if(!ChangeStatus(CRHL_Unit_Mag::LFProcEnd))
//	{
//		if(nTrans > 0) Rollback(nTrans);
//		return FALSE;
//	}
...
//	Lid_Life++;
//
//	if(!ChangeStatus(CRHL_Unit_Mag::LFWaiting))
//	{
//		if(nTrans > 0) Rollback(nTrans);
//		return FALSE;
//	}	
...
//}
//
///// <Method class="CRHL_Unit_Mag" name="ChangeDeviceStatus" type="L3BOOL">
///// 修改设备状态
///// <Param name="nStatus" type="L3LONG">新设备状态</Param>
///// <Param name="reason" type="L3STRING">原因</Param>
///// </Method>
//L3BOOL CRHL_Unit_Mag::ChangeDeviceStatus(L3LONG nStatus, L3STRING reason)
//{
//	LONG nTrans = 0;
//	if(!IsInTrans())
//	{
...
//}
//
///// <Method class="CRHL_Unit_Mag" name="OnTimer" type="L3BOOL">
///// 处理定时器事件
///// <Param name="nEventID" type="L3ULONG">事件ID</Param>
///// </Method>
//L3BOOL CRHL_Unit_Mag::OnTimer(L3ULONG nEventID)
//{
...
//
//
///// <Method class="CRHL_Unit_Mag" name="StartHeating" type="L3BOOL">
///// 处理加热开始事件
///// </Method>
//L3BOOL CRHL_Unit_Mag::StartHeating()
//{
//	LONG nTrans = 0;
//	if(!IsInTrans())
//	{
...
//	}
//
//	if ((Status >= CRHL_Unit_Mag::LFProcBegin) && (Status < CRHL_Unit_Mag::LFProcEnd)) //2009-01-11 添加条件限制
//	{
//		HeatStartTime = COleDateTime::GetCurrentTime();
//		if(!ChangeStatus(CRHL_Unit_Mag::LFHeatBegin))
//		{
//			if(nTrans > 0)
//				Rollback(nTrans);
//			return FALSE;
...
//}
//
///// <Method class="CRHL_Unit_Mag" name="StopHeating" type="L3BOOL">
///// 处理加热结束事件
///// </Method>
//L3BOOL CRHL_Unit_Mag::StopHeating()
//{
//	LONG nTrans = 0;
//	if(!IsInTrans())
//	{
...
//		if(!ChangeStatus(CRHL_Unit_Mag::LFHeatEnd))
//		{
//			if(nTrans > 0)
//				Rollback(nTrans);
//			return FALSE;
...
//}
//
///// <Method class="CRHL_Unit_Mag" name="StartBlowing" type="BOOL">
///// 处理软吹开始事件
///// <Param name="Area" type="L3STRING">开始软吹的工位</Param>
///// </Method>
//BOOL CRHL_Unit_Mag::StartBlowing(L3STRING Area)
//{
//	LONG nTrans = 0;
//	if(!IsInTrans())
//	{
...
//	if(!strAreaURI.IsEmpty())
//	{
//		if(!SetObjectPropValue(strAreaURI,_T("Status"),CL3Variant((LONG)CRHL_Unit_Mag::LFBlowBegin)))
//		{
//			if(nTrans > 0) Rollback(nTrans);
//			return FALSE;
//		}
...
//	rsStatus.SetFieldByName(_T("TreatNo"),CL3Variant(strTreatNo));
//	rsStatus.SetFieldByName(_T("HeatID"),CL3Variant(strHeatID));
//	rsStatus.SetFieldByName(_T("Status"),CL3Variant((LONG)CRHL_Unit_Mag::LFBlowBegin));
//	rsStatus.SetFieldByName(_T("Change_Time"),CL3Variant(COleDateTime::GetCurrentTime()));
//	if(CreateNewObjects(LF_PROCESS_STATUS_CLASS_URI,rsStatus) < 1)
//	{
//		if(nTrans > 0)
...
//}
//
///// <Method class="CRHL_Unit_Mag" name="StopBlowing" type="L3BOOL">
///// 处理软吹结束事件
///// <Param name="Area" type="L3STRING">结束软吹的工位</Param>
///// </Method>
//L3BOOL CRHL_Unit_Mag::StopBlowing(L3STRING Area)
//{
//	LONG nTrans = 0;
//	if(!IsInTrans())
//	{
...
//	if(!strAreaURI.IsEmpty())
//	{
//		if(!SetObjectPropValue(strAreaURI,_T("Status"),CL3Variant((LONG)CRHL_Unit_Mag::LFBlowEnd)))
//		{
//			if(nTrans > 0) Rollback(nTrans);
//			return FALSE;
//		}
...
//	rsStatus.SetFieldByName(_T("TreatNo"),CL3Variant(strTreatNo));
//	rsStatus.SetFieldByName(_T("HeatID"),CL3Variant(strHeatID));
//	rsStatus.SetFieldByName(_T("Status"),CL3Variant((LONG)CRHL_Unit_Mag::LFBlowEnd));
//	rsStatus.SetFieldByName(_T("Change_Time"),CL3Variant(COleDateTime::GetCurrentTime()));
//	if(CreateNewObjects(LF_PROCESS_STATUS_CLASS_URI,rsStatus) < 1)
//	{
//		if(nTrans > 0)
...
//}
//
///// <Method class="CRHL_Unit_Mag" name="SteelLeave" type="L3BOOL">
///// 处理钢水离站事件
///// <Param name="Area" type="L3STRING">离站钢水工位</Param>
///// </Method>
//L3BOOL CRHL_Unit_Mag::SteelLeave(L3STRING Area)
//{
//	CString strArea = String_BSTR2TChar(Area);
//
//	strArea.Trim();
...
//
//	//2009-04-03 状态判定
//	if(iAreaStatus < CRHL_Unit_Mag::LFProcEnd||iAreaStatus==CRHL_Unit_Mag::LFBlowBegin)
//	{
//		SetL3LastError(XGMES_ERR_LF_WRONGSTATUS);
//		return FALSE;
//	}
...
//}
//
///// <Method class="CRHL_Unit_Mag" name="ChangeSteelGradeApp" type="L3BOOL">
///// 申请改钢
///// <Param name="Reason" type="L3STRING">原因</Param>
///// </Method>
//L3BOOL CRHL_Unit_Mag::ChangeSteelGradeApp(L3STRING Reason)
//{
//	CL3RecordSetWrap rsSteel;
...
//
//
///// <Method class="CRHL_Unit_Mag" name="SteelReturnApp" type="L3BOOL">
/////  钢水回炉申请2009-02-28 增加炉号
///// <Param name="Reason" type="L3STRING">原因</Param>
///// </Method>
//L3BOOL CRHL_Unit_Mag::SteelReturnApp(L3STRING Reason,L3STRING strHeatID)
//{
...
//
//
///// <Method class="CRHL_Unit_Mag" name="SteelBackApp" type="L3BOOL">
/////  钢水返送申请
///// <Param name="Reason" type="L3STRING">原因</Param>
///// </Method>
//L3BOOL CRHL_Unit_Mag::SteelBackApp(L3STRING Reason,L3STRING strHeatID)
//{
//	CString csHeatID = strHeatID;
//	CL3RecordSetWrap rsSteel;
...
//
//
///// <Method class="CRHL_Unit_Mag" name="AcceptMaterialDischargeData" type="L3RECORDSET">
///// 料仓加料数据采集
///// 新增4#LF，可共用此方法hyh 2012-05-09
///// <Param name="HeatID" type="L3STRING">炉号</Param>
///// </Method>
//L3BOOL CRHL_Unit_Mag::AcceptMaterialDischargeData(L3RECORDSET rsMaterialData)
//{
//	/*屏蔽 hyh 2012-06-28
...
//
//
///// <Method class="CRHL_Unit_Mag" name="MaterialGroundDischargeData" type="L3RECORDSET">
///// 袋装合金散状料消耗
///// <Param name="HeatID" type="L3STRING">炉号</Param>
///// </Method>
//L3BOOL CRHL_Unit_Mag::MaterialGroundDischargeData(L3RECORDSET rsMaterialData)
//{
//	CL3RecordSetWrap rsData =rsMaterialData;
//	if( rsData.IsNull() || rsData.GetRowCount() < 1)
//		return FALSE;
...
//
//
///// <Method class="CRHL_Unit_Mag" name="AcceptLFArrivalData" type="L3BOOL">
///// 接收LF炉钢包到达数据 2008-12-28
///// 新增4#LF，可共用此方法 hyh 2012-05-09
///// <Param name="rsData" type="L3RECORDSET">到达数据</Param>
///// </Method>
//L3BOOL CRHL_Unit_Mag::AcceptLFArrivalData(L3RECORDSET rsData)
//{
...
//}
//
///// <Method class="CRHL_Unit_Mag" name="AcceptLFStartProcessData" type="L3BOOL">
///// 接收LF炉处理开始数据 2008-12-28
///// 新增4#LF，可共用此方法 hyh 2012-05-09
///// <Param name="rsData" type="L3RECORDSET">到达数据</Param>
///// </Method>
//L3BOOL CRHL_Unit_Mag::AcceptLFStartProcessData(L3RECORDSET rsData)
//{
//	CL3RecordSetWrap rs = rsData;
//	if(rs.GetRowCount() < 1)
//		return TRUE;
...
//}
//
///// <Method class="CRHL_Unit_Mag" name="AcceptLFEndProcessData" type="L3BOOL">
///// 接收LF炉处理结束数据 2008-12-30
///// 新增4#LF，可共用此方法 hyh 2012-05-09
///// <Param name="rsData" type="L3RECORDSET">到达数据</Param>
///// </Method>
//L3BOOL CRHL_Unit_Mag::AcceptLFEndProcessData(L3RECORDSET rsData)
//{
//	CL3RecordSetWrap rs = rsData;
//	if(rs.GetRowCount() < 1)
//		return TRUE;
...
//}
//
///// <Method class="CRHL_Unit_Mag" name="AcceptLFHeatData" type="L3BOOL">
///// 接收LF炉加热数据 2008-12-28
///// 新增4#LF，可共用此方法hyh 2012-05-09
///// <Param name="rsData" type="L3RECORDSET">加热开始数据</Param>
///// </Method>
//L3BOOL CRHL_Unit_Mag::AcceptLFHeatData(L3RECORDSET rsData)
//{
//	CL3RecordSetWrap rs = rsData;
//	if(rs.GetRowCount() < 1)
//		return TRUE;
...
//}
//
///// <Method class="CRHL_Unit_Mag" name="AcceptLFStartSoftBlowData" type="L3BOOL">
///// 接收LF炉软吹开始数据 2008-12-30
///// 新增4#LF，可共用此方法hyh 2012-05-09
///// <Param name="rsData" type="L3RECORDSET">到达数据</Param>
///// </Method>
//L3BOOL CRHL_Unit_Mag::AcceptLFStartSoftBlowData(L3RECORDSET rsData)
//{
//	CL3RecordSetWrap rs = rsData;
//	if(rs.GetRowCount() < 1)
//		return TRUE;
...
//}
//
///// <Method class="CRHL_Unit_Mag" name="AcceptLFStopSoftBlowData" type="L3BOOL">
///// 接收LF炉处理结束数据 2008-12-30
///// 新增4#LF，可共用此方法hyh 2012-05-09
///// <Param name="rsData" type="L3RECORDSET">到达数据</Param>
///// </Method>
//L3BOOL CRHL_Unit_Mag::AcceptLFStopSoftBlowData(L3RECORDSET rsData)
//{
//	CL3RecordSetWrap rs = rsData;
//	if(rs.GetRowCount() < 1)
//		return TRUE;
...
//}
//
///// <Method class="CRHL_Unit_Mag" name="AcceptLFTempData" type="L3BOOL">
///// 接收LF炉测温数据 2008-12-30
///// 新增4#LF，可共用此方法 hyh 2012-05-09
///// <Param name="rsData" type="L3RECORDSET">测温数据</Param>
///// </Method>
//L3BOOL CRHL_Unit_Mag::AcceptLFTempData(L3RECORDSET rsData)
//{
//	CL3RecordSetWrap rs = rsData;
//	if(rs.GetRowCount() < 1)
//		return TRUE;
...
//	if(!CreateClassPropSet(_T("XGMESLogic\\LFMag\\CRHL_Temp_Data"),rsTemp))
//	{
//		return FALSE;
//	}
//
...
//		CString csHeatID;
//		if (nStatus == CRHL_Unit_Mag::LFWaiting)
//		{
...
//
//	rsTemp.MoveFirst();
//	if(CreateNewObjects(_T("XGMESLogic\\LFMag\\CRHL_Temp_Data"),rsTemp) < rsTemp.GetRowCount())
//	{
//		return FALSE;
//	}
//
...
//BOOL CRHL_Unit_Mag::ChangeAreaStatus(LPCTSTR csAreaID,LONG nStatus)
//{
...
//}
//
///// <Method class="CRHL_Unit_Mag" name="SetTreatNoForTempDataBeforeProcess" type="L3BOOL">
///// 对处理开始前测温设置处理号数据项 2008-12-30
///// <Param name="csHeatID" type="LPCTSTR">炉号</Param>
///// <Param name="csTreatNo" type="LPCTSTR">处理号</Param>
///// </Method>
//L3BOOL CRHL_Unit_Mag::SetTreatNoForTempDataBeforeProcess(LPCTSTR csHeatID,LPCTSTR csTreatNo)
//{
//	CString strSQL;
//	strSQL.Format(_T("select * from CRHL_Temp_Data where HeatID = '%s' order by MeasureTime"),csHeatID);
//	CL3RecordSetWrap rs;
//	if(!Query(strSQL,rs))
//		return FALSE;
//
...
//}
//
///// <Method class="CRHL_Unit_Mag" name="SetDepartureTemp" type="L3BOOL">
///// 设置离站温度 2009-01-02
///// <Param name="csTreatNo" type="LPCTSTR">处理号</Param>
///// </Method>
//L3BOOL CRHL_Unit_Mag::SetDepartureTemp(LPCTSTR csTreatNo)
//{
//	CString strSQL;
//	strSQL.Format(_T("select * from CRHL_Temp_Data where TreatNo = '%s' order by MeasureTime desc"),csTreatNo);
//	CL3RecordSetWrap rs;
//	if(!Query(strSQL,rs))
//		return FALSE;
//
...
//}
//
///// <Method class="CRHL_Unit_Mag" name="SetWireTemp" type="L3BOOL">
///// 设置钙处理结束温度 2009-01-02
///// <Param name="csTreatNo" type="LPCTSTR">处理号</Param>
///// </Method>
//L3BOOL CRHL_Unit_Mag::SetWireTemp(LPCTSTR csTreatNo)
//{
//	CString strSQL;
//	strSQL.Format(_T("select * from CRHL_Temp_Data where TreatNo = '%s' order by MeasureTime desc"),csTreatNo);
//	CL3RecordSetWrap rs;
...
//}
//
///// <Method class="CRHL_Unit_Mag" name="AcceptLFWireData" type="L3BOOL">
///// 接收LF炉喂线数据 2009-01-02
///// <Param name="rsData" type="L3RECORDSET">喂线数据</Param>
///// </Method>
//L3BOOL CRHL_Unit_Mag::AcceptLFWireData(L3RECORDSET rsData)
//{
...
//
//	CL3RecordSetWrap rsLog;
//	if(!CreateClassPropSet(_T("XGMESLogic\\LFMag\\CRHL_Wire_Data"),rsLog))
//		return NULL;
//
//	//组建数据集合金原料库出库
//	CL3RecordSet *pRSAlloy = new CL3RecordSet();
...
//	}
//
//	if(CreateNewObjects(_T("XGMESLogic\\LFMag\\CRHL_Wire_Data"),rsLog) < rsLog.GetRowCount())
//		return FALSE;
//
//	if(!rsAlloyOut.IsNull() && rsAlloyOut.GetRowCount() > 0)
//	{
...
//}
//
///// <Method class="CRHL_Unit_Mag" name="AcceptLFOxygenData" type="L3BOOL">
///// 接收LF炉定氧数据 2009-01-02
///// 新增4#LF，可共用此方法 hyh 2012-05-09
///// <Param name="rsData" type="L3RECORDSET">定氧数据</Param>
///// </Method>
//L3BOOL CRHL_Unit_Mag::AcceptLFOxygenData(L3RECORDSET rsData)
//{
//	CL3RecordSetWrap rs = rsData;
//	if(rs.GetRowCount() < 1)
//		return TRUE;
...
//	if(!CreateClassPropSet(_T("XGMESLogic\\LFMag\\CRHL_Oxygen_Data"),rsOxygen))
//	{
//		return FALSE;
//	}
//
...
//
//	rsOxygen.MoveFirst();
//	if(CreateNewObjects(_T("XGMESLogic\\LFMag\\CRHL_Oxygen_Data"),rsOxygen) < rsOxygen.GetRowCount())
//	{
//		return FALSE;
//	}
//
...
//}
//
///// <Method class="CRHL_Unit_Mag" name="AcceptLFWeightData" type="L3BOOL">
///// 接收LF炉称重数据 2009-01-08
///// <Param name="rsData" type="L3RECORDSET">称重数据</Param>
///// </Method>
//L3BOOL CRHL_Unit_Mag::AcceptLFWeightData(L3RECORDSET rsData)
//{
//	CL3RecordSetWrap rs = rsData;
//	if(rs.GetRowCount() < 1)
//		return TRUE;
...
///// <Param name="Reason" type="L3STRING">原因</Param>
///// </Method>
//L3RECORDSET CRHL_Unit_Mag::GetPreThreeHeatID()
//{
//	CString csUnitID = GetIdentity().ToCString();
//	CString csLFID = csUnitID.Mid(2,1);
//	CString csTempSQL =_T("select * from (select HeatID from CRHL_Base_Data where substr(TreatNo,1,1) = '%s'  order by  ProductionDate desc) where rownum < 5");
//	CString csSQL;
...
//}
//
///// <Method class="CRHL_Unit_Mag" name="DoBlowwing" type="L3BOOL">
///// 判定是否软吹开始 2009-03-09
///// <Param name="strAreaUri" type="LPCTSTR">工序对象Uri</Param>
///// <Param name="strHeatID" type="LPCTSTR">炉号</Param>
///// </Method>
//L3BOOL CRHL_Unit_Mag::DoBlowwing(LPCTSTR strAreaUri,LPCTSTR strHeatID)
//{
...
//}
//
///// <Method class="CRHL_Unit_Mag" name="AcceptLFHeatGears" type="L3BOOL">
///// 接收LF加热挡位数据 2009-03-23
///// 新增4#LF，可共用此方法hyh 2012-05-09
///// <Param name="rsData" type="L3RECORDSET">挡位数据</Param>
///// </Method>
//L3BOOL CRHL_Unit_Mag::AcceptLFHeatGears(L3RECORDSET rsData)
//{
//	CL3RecordSetWrap rs = rsData;
//	if(rs.GetRowCount() < 1)
//		return TRUE;
...
//	if(!CreateClassPropSet(_T("XGMESLogic\\LFMag\\CRHL_Heat_Gears"),rsGears))
//	{
//		return FALSE;
//	}
//
...
//
//	rsGears.MoveFirst();
//	if(CreateNewObjects(_T("XGMESLogic\\LFMag\\CRHL_Heat_Gears"),rsGears) < rsGears.GetRowCount())
//	{
//		return FALSE;
//	}
//
...
//}
//
///// <Method class="CRHL_Unit_Mag" name="AcceptLFBlowArData" type="L3BOOL">
///// 接收LF炉吹氩流量数据 2009-03-23
///// 新增4#LF，可共用此方法hyh 2012-05-09
///// <Param name="rsData" type="L3RECORDSET">吹氩流量数据</Param>
///// </Method>
//L3BOOL CRHL_Unit_Mag::AcceptLFBlowArData(L3RECORDSET rsData)
//{
//	CL3RecordSetWrap rs = rsData;
//	if(rs.GetRowCount() < 1)
//		return TRUE;
...
//	if(!CreateClassPropSet(_T("XGMESLogic\\LFMag\\CRHL_BlowAr_Data"),rsBlowAr))
//	{
//		return FALSE;
//	}
//
...
//
//	rsBlowAr.MoveFirst();
//	if(CreateNewObjects(_T("XGMESLogic\\LFMag\\CRHL_BlowAr_Data"),rsBlowAr) < rsBlowAr.GetRowCount())
//	{
//		return FALSE;
//	}
//
...
//}
//
///// <Method class="CRHL_Unit_Mag" name="SetTreatNoForBlowArData" type="L3BOOL">
///// 对处理开始前吹氩数据设置处理号数据项 2009-03-23
///// <Param name="csHeatID" type="LPCTSTR">炉号</Param>
///// <Param name="csTreatNo" type="LPCTSTR">处理号</Param>
///// </Method>
//L3BOOL CRHL_Unit_Mag::SetTreatNoForBlowArData(LPCTSTR csHeatID,LPCTSTR csTreatNo)
//{
//	CString strSQL;
//	strSQL.Format(_T("select * from CRHL_BlowAr_Data where HeatID = '%s' and TreatNo is null order by LogTime"),csHeatID);
//	CL3RecordSetWrap rs;
//	if(!Query(strSQL,rs))
//		return FALSE;
//
...
//	{
//		CString csGUID = rs.GetFieldByName(_T("GUID")).ToCString();
//        CString csTempDataUri = CL3NameParser::MergeClassDomainName(_T("XGMESLogic\\LFMag\\CRHL_BlowAr_Data"),csGUID);
//		SetObjectPropValue(csTempDataUri,_T("TreatNo"),CL3Variant(csTreatNo));
//		rs.MoveNext();
//	}
//
...
//}
//
///// <Method class="CRHL_Unit_Mag" name="AcceptLFBlowArFlow" type="L3BOOL">
///// 接收LF实绩吹氩数据 2009-03-23
///// <Param name="rsData" type="L3RECORDSET">挡位数据</Param>
///// </Method>
//L3BOOL CRHL_Unit_Mag::AcceptLFBlowArFlow(L3RECORDSET rsData)
//{
//	CL3RecordSetWrap rs = rsData;
//	int rsCount = rs.GetRowCount();
//	if(rsCount < 1)
...
//		{
//			//获取LF管理对象
//			CString strLFMag = CL3NameParser::MergeClassDomainName(_T("XGMESLogic\\LFMag\\CRHL_Unit_Mag"),strLFID);
...
//			CString strLFProdArea = CL3NameParser::MergeClassDomainName(_T("XGMESLogic\\LFMag\\CRHL_Prod_Area"),strAreaID);
...
//
////计算等压钢时间2009-03-28
//L3LONG CRHL_Unit_Mag::CalculateHoldTime(LPCTSTR lpcszTreatNo,L3DATETIME dArrival)
//{
...
//		return 0;
//	}
//    CL3Variant valEndTime = GetObjectPropValue(_T("XGMESLogic\\LFMag\\CRHL_Process_Data\\")+csLastTreatNo,_T("End_Time"));
...
//
///// 获取前处理号 2009-03-28
//CString CRHL_Unit_Mag::GetPreviousTreatNo(LPCTSTR lpcszTreatNo)
//{
...
//	CString csTempSQL =_T("select Max(TreatNo) as TreatNo from CRHL_Base_Data where substr(TreatNo,1,1) = '%s' and TreatNo < '%s'");
//	CString csSQL;
...
//
//
///// <Method class="CRHL_Unit_Mag" name="ModifyLadleGrade" type="L3LONG">
///// 修改包况//2009-03-30 Liao
///// <Param name="strTreatNo" type="L3STRING">处理号</Param>
///// <Param name="strLadleGrade" type="L3STRING">包况</Param>
///// </Method>
//L3LONG CRHL_Unit_Mag::ModifyLadleGrade(L3STRING strTreatNo, L3STRING strLadleGrade)
//{
//	// TODO : 请在此添加逻辑代码
...
///// <Method class="CRHL_Unit_Mag" name="CalEleRateValue" type="L3LONG">
///// 计算最进化验结果比值
...
///// </Method>
//L3FLOAT CRHL_Unit_Mag::CalEleRateValue(L3STRING strHeatID, L3STRING strEleName1,L3STRING strEleName2)
//{
//	CString csHeatID=strHeatID;
