// 逻辑类CRHL_Prod_Area头文件
// 本文件是由L3集成开发环境自动生成，在没有充分了解本文件的内容前，请不要随意修改本文件中的内容
// 否则可能带来严重后果。
#pragma once
#include "ProduceArea.h"

class CRHL_Prod_Area :
	public ProduceArea
{
public:
	CRHL_Prod_Area(void);
	virtual ~CRHL_Prod_Area(void);

	DECLARE_L3CLASS(CRHL_Prod_Area,XGMESLogic\\LFMag, Name)
	DECLARE_L3PROPTABLE()
	DECLARE_L3METHODMAP(CRHL_Prod_Area)
...
protected:
	...
	/// <Property class="CRHL_Unit_Mag" name="Status" type="L3LONG">
	/// 工位状态
	/// </Property>
	DECLARE_L3PROP_LONG(Status)

	/// <Property class="CRHL_Prod_Area" name="NextSteel" type="L3STRING">
	/// 下一个要到达的钢水号
	/// </Property>
	DECLARE_L3PROP_STRING(NextSteel)

	/// <Property class="CRHL_Prod_Area" name="TreatNo" type="L3STRING">
	/// 当前处理号
	/// </Property>
	DECLARE_L3PROP_STRING(TreatNo)

	/// <Property class="CRHL_Prod_Area" name="HeatID" type="L3STRING">
	/// 当前炉号
	/// </Property>
	DECLARE_L3PROP_STRING(HeatID)

	/// <Property class="CRHL_Prod_Area" name="LadleID" type="L3STRING">
	/// 当前钢包号
	/// </Property>
	DECLARE_L3PROP_STRING(LadleID)

	/// <Property class="CRHL_Prod_Area" name="SteelGradeIndex" type="L3STRING">
	/// 当前炼钢记号
	/// </Property>
	DECLARE_L3PROP_STRING(SteelGradeIndex)

	/// <Property class="CRHL_Prod_Area" name="Weight" type="L3DOUBLE">
	/// 当前重量
	/// </Property>
	DECLARE_L3PROP_DOUBLE(Weight)

	/// <Property class="CRHL_Prod_Area" name="Arrive_Time" type="L3DATETIME">
	/// 到达时间
	/// </Property>
	DECLARE_L3PROP_DATETIME(Arrive_Time)

	/// <Property class="CRHL_Prod_Area" name="SoftBlowTime" type="L3LONG">
	/// 软吹计时
	/// </Property>
	DECLARE_L3PROP_LONG(SoftBlowTime)

	/// <Property class="CRHL_Prod_Area" name="WiredFlag" type="L3LONG">
	/// 钙处理标志
	/// </Property>
