// 逻辑类CLF_Prod_Area的用户逻辑程序源文件
// 用户系统的逻辑程序应放在本文件中实现，逻辑函数的定义应放在_CLF_Prod_Area.h中。
// 由于本文件中定义的函数均为L3集成开发环境自动生成，且在_CLF_Prod_Area.h和
...
/// </summary>
BOOL CLF_Prod_Area::OnBeforeProcess(L3RECORDSET rsParameter)
{
	// TODO: 在此处编辑相关功能的处理代码
...
/// </summary>
BOOL CLF_Prod_Area::ProcessMaterials(L3RECORDSET rsMaterials,L3RECORDSET rsParameter,L3LONG* pnProcessType,L3RECORDSET *prsProducts,L3RECORDSET *prsMaterialMap)
{
	// TODO: 在此处编辑相关功能的处理代码
...
/// RET << 成功返回TRUE；失败返回FALSE。
/// </summary>
BOOL CLF_Prod_Area::OnAfterProcessed(L3RECORDSET rsMaterials,L3RECORDSET rsParameter,L3LONG nProcessType,L3RECORDSET rsProducts,L3RECORDSET rsMaterialMap)
{
	// TODO: 在此处编辑相关功能的处理代码
...
/// 材料添加前导处理
/// </summary>
BOOL CLF_Prod_Area::OnBeforeAddMaterials(L3RECORDSET rsMaterials)
{
...
/// 材料添加后续处理
/// </summary>
BOOL CLF_Prod_Area::OnAfterMaterialsAdded(L3RECORDSET rsMaterials)
{
...
/// 材料移出后续处理
/// </summary>
BOOL CLF_Prod_Area::OnAfterMaterialsRemoved(L3RECORDSET rsMaterials)
{
	CL3RecordSetWrap rs = rsMaterials;
	if(rs.GetRowCount() < 1)
	{
...
/// RET << 位置编码
/// </summary>
CString CLF_Prod_Area::GetPositionCode()
{
	return GetPropValue(_T("Code")).ToCString();
}

/// <Method class="CLF_Prod_Area" name="OnTimer" type="L3BOOL">
/// 处理定时器事件
/// <Param name="nEventID" type="L3ULONG">定时器事件ID</Param>
/// </Method>
L3BOOL CLF_Prod_Area::OnTimer(L3ULONG nEventID)
{
	...
	{	// 软吹吹定时器
		...
		CString csSql;
		csSql.Format(_T("select SoftBlow_StartTime from CLF_Process_Data where HeatID='%s'"),csHeatID);
		CL3RecordSetWrap rs;
...
/// <Method class="CLF_Prod_Area" name="SetLFAreaTimer" type="L3BOOL">
/// 启动定时器事件
/// </Method>
L3BOOL CLF_Prod_Area::SetLFAreaTimer()
{
	SoftBlowTime = 0;
...
/// <Method class="CLF_Prod_Area" name="KillLFAreaTimer" type="L3BOOL">
/// 停止定时器事件
/// </Method>
L3BOOL CLF_Prod_Area::KillLFAreaTimer()
{
	if(m_iTimer != 0)
