// 逻辑类CAlloy_Store_Communicator头文件
// 本文件是由L3集成开发环境自动生成，在没有充分了解本文件的内容前，请不要随意修改本文件中的内容
// 否则可能带来严重后果。
#pragma once
#include "MESCommunicator.h"

class CAlloy_Store_Communicator :
	public MESCommunicator
{
public:
	CAlloy_Store_Communicator(void);
	virtual ~CAlloy_Store_Communicator(void);

	DECLARE_L3CLASS(CAlloy_Store_Communicator,XGMESLogic\\AlloyStoreMag, Name)
	DECLARE_L3PROPTABLE()
	DECLARE_L3METHODMAP(CAlloy_Store_Communicator)
