// 逻辑类CQA_Iron_Element头文件
// 本文件是由L3集成开发环境自动生成，在没有充分了解本文件的内容前，请不要随意修改本文件中的内容
// 否则可能带来严重后果。
#pragma once

class CQA_Iron_Element :
	public CL3Object
{
public:
	CQA_Iron_Element(void);
	virtual ~CQA_Iron_Element(void);

	DECLARE_L3CLASS(CQA_Iron_Element,XGMESLogic\\QualityMag, GUID)
	DECLARE_L3PROPTABLE()
	DECLARE_L3METHODMAP(CQA_Iron_Element)
	...
	/// <Property class="CQA_Iron_Element" name="AppID" type="L3STRING">
	/// 委托单编号
	/// </Property>
	DECLARE_L3PROP_STRING(AppID)

	/// <Property class="CQA_Iron_Element" name="TAP_No" type="L3STRING">
	/// 铁次号
	/// </Property>
	DECLARE_L3PROP_STRING(TAP_No)

	/// <Property class="CQA_Iron_Element" name="TPC_No" type="L3STRING">
	/// 罐号
	/// </Property>
	DECLARE_L3PROP_STRING(TPC_No)

	/// <Property class="CQA_Iron_Element" name="Sample_Code" type="L3STRING">
	/// 试样编码
	/// </Property>
	DECLARE_L3PROP_STRING(Sample_Code)

	/// <Property class="CQA_Iron_Element" name="Arrive_Date" type="L3DATETIME">
	/// 到样时间
	/// </Property>
	DECLARE_L3PROP_DATETIME(Arrive_Date)

	/// <Property class="CQA_Iron_Element" name="Report_Date" type="L3DATETIME">
	/// 报告时间
	/// </Property>
	DECLARE_L3PROP_DATETIME(Report_Date)

	/// <Property class="CQA_Iron_Element" name="UnitTypeID" type="L3SHORT">
	/// 工序：0：铁水，1：混铁炉，2：转炉，3：炉后，4：LF，5：RH，6：铸机
	/// </Property>
	DECLARE_L3PROP_LONG(UnitTypeID)

	/// <Property class="CQA_Iron_Element" name="UnitID" type="L3SHORT">
	/// 工位
	/// </Property>
	DECLARE_L3PROP_LONG(UnitID)

	/// <Property class="CQA_Iron_Element" name="Sample_Address" type="L3STRING">
	/// 取样地点
	/// </Property>
	DECLARE_L3PROP_STRING(Sample_Address)

	/// <Property class="CQA_Iron_Element" name="Sample_Type" type="L3STRING">
	/// 试样类别
	/// </Property>
	DECLARE_L3PROP_STRING(Sample_Type)

	/// <Property class="CQA_Iron_Element" name="Sample_Count" type="L3STRING">
	/// 取样次数
	/// </Property>
	DECLARE_L3PROP_STRING(Sample_Count)

	/// <Property class="CQA_Iron_Element" name="C" type="L3STRING">
	/// C
	/// </Property>
	DECLARE_L3PROP_STRING(C)

	/// <Property class="CQA_Iron_Element" name="Si" type="L3STRING">
	/// Si
	/// </Property>
	DECLARE_L3PROP_STRING(Si)

	/// <Property class="CQA_Iron_Element" name="Mn" type="L3STRING">
	/// Mn
	/// </Property>
	DECLARE_L3PROP_STRING(Mn)

	/// <Property class="CQA_Iron_Element" name="P" type="L3STRING">
	/// P
	/// </Property>
	DECLARE_L3PROP_STRING(P)

	/// <Property class="CQA_Iron_Element" name="S" type="L3STRING">
	/// S
	/// </Property>
	DECLARE_L3PROP_STRING(S)

	/// <Property class="CQA_Iron_Element" name="S_Before" type="L3STRING">
	/// S_Before
	/// </Property>
	DECLARE_L3PROP_STRING(S_Before)

	/// <Property class="CQA_Iron_Element" name="S_After" type="L3STRING">
	/// S_After
	/// </Property>
	DECLARE_L3PROP_STRING(S_After)

	/// <Property class="CQA_Iron_Element" name="Ti" type="L3STRING">
	/// Ti
	/// </Property>
	...
	/// <Property class="CQA_Iron_Element" name="LogTime" type="L3DATETIME">
	/// 数据记录时间
	/// </Property>
	DECLARE_L3PROP_DATETIME(LogTime)

	/// <Property class="CQA_Iron_Element" name="DataLogMode" type="L3SHORT">
	/// 数据产生方式：0：自动采集化验室；1：人工输入化验室;
	/// </Property>
	DECLARE_L3PROP_LONG(DataLogMode)

	/// <Property class="CQA_Iron_Element" name="Operator" type="L3STRING">
	/// 检验人
	/// </Property>2009-04-23
